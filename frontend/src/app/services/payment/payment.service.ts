...
export class PaymentService {
  ...
  sendMail(oid: string, date: string, name: string, email: string, address: string, totalPrice: number,  productArray: object) {
    return this.http.post(URL_HOST + '/api/mail?oid=' + oid + '&date=' + date +
     '&name=' + name + '&email=' + email + '&address=' + address + '&totalPrice=' + totalPrice, productArray);
  }
}
